...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  MANUAL STEP REQUIRED: Grant Lakebase project permissions      ║"
echo "╠══════════════════════════════════════════════════════════════════╣"
echo "║                                                                ║"
echo "║  The service principal needs 'Can Manage' on your Lakebase     ║"
echo "║  project to create/delete CI branches and run migrations.      ║"
echo "║  There is no CLI/API for this — it must be done in the UI.     ║"
echo "║                                                                ║"
echo "║  In Databricks workspace:                                      ║"
echo "║    Lakebase → ${LAKEBASE_PROJECT_ID} → Permissions"
echo "║    → Add '${SP_NAME}' → Can Manage"
echo "║                                                                ║"
echo "║  Do this now, before your first PR or merge.                   ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
